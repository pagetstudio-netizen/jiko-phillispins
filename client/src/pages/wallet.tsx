...
import { getPaymentMethodsForCountry, type DynamicCountry } from "@/lib/countries";
...
export default function WalletPage() {
  ...
  const paymentMethods = getPaymentMethodsForCountry(user.country, dynamicCountries);
