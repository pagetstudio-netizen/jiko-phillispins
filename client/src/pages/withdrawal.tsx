...
export default function WithdrawalPage() {
  ...
  const withdrawMutation = useMutation({
    ...
    onSuccess: () => {
      toast({ title: "Demande envoyée", description: "Votre demande de retrait a été transmise." });
      refreshUser();
  ...
  const handleSubmit = () => {
    ...
    if (!selectedWallet) {
      toast({ title: "Compte requis", description: "Veuillez sélectionner un compte de paiement", variant: "destructive" });
      return;
    }
    ...
    <div style={{ minHeight: "100vh", background: "#111111", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, padding: "14px 12px 100px", display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div style={{ background: "#1a1a1a", borderRadius: 14, padding: "16px 14px" }}>
          <p style={{ color: "#9ca3af", fontSize: 13, marginBottom: 10 }}>Sélectionnez un compte de paiement</p>
          ...
          >
            ...
            <span style={{
              ...
              {selectedWallet
                ...
                : "Veuillez sélectionner un compte de paiement"}
            </span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ color: "#9ca3af", fontSize: 13, lineHeight: 1.7, display: "flex", flexDirection: "column", gap: 6 }}>
            {[
              ...
              `3. Vous pouvez effectuer des retraits à tout moment. Les retraits sont traités sous 4 à 24 heures.`,
              `4. Pour protéger les intérêts de la plateforme et de ses membres, vous devez avoir au moins un produit actif pour activer la fonction de retrait.`,
            ].map((text, i) => (
